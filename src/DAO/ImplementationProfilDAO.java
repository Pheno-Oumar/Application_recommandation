...
import CompetenceMapper.CompetenceMapper;
import Enumeration.TypeZone;
import Interface.Database;
import Interface.InterfaceProfilDAO;
import Model.Competence;
import Model.Profil;

public class ImplementationProfilDAO implements InterfaceProfilDAO {

    private final Database db;

    public ImplementationProfilDAO(Database db) {
        this.db = db;
    }
